  ...
  return (
    <div name='home' className='w-full h-screen bg-[#1A2238]' >
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full' >
           ...
           <div>
            <button className='text-[#FF6A3D] group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#9daaf2] hover:border-[#ff6a3d]' >View Projects <HiArrowNarrowRight/></button>
           </div>
      </div>
    </div>
  )
