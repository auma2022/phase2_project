...
import Facebook from '../assets/facebookclone.jpeg';
...
const Work = () => {
  return (
    <div name='projects' className='w-full md:h-screen mt-[250px] text-[#9daaf2] bg-[#1a2238]'>
...
{/* Container */}
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100'>
              ...
              <div className='pt-8 text-center'>
                <a href='/'>
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-[#ff6a3d] text-[#1a2238] font-bold text-lg'>
                    Demo
                  </button>
                </a>
                <a href='/'>
          ...
          >
            {/* Hover Effects */}
            <div className='opacity-0 group-hover:opacity-100'>
              <span className='text-2xl font-bold text-[] tracking-wider'>
                Tiktok clone
              </span>
              <div className='pt-8 text-center'>
                <a href='/'>
